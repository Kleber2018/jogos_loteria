...
import { Lotofacil } from '../../assets/base64/logos';
      ...
      return {
        ...
        header: [{
          ...
          table: {
            ...
            heights: [19],
            body: [
              [ {image: Lotofacil, width: 96, margin: [0,1,0,0]},
                {text: 'FECHAMENTO DA LOTOFÁCIL', bold: true, fontSize: 13, margin: [0,2,0,0]}, 
                {text: [
